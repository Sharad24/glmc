...
inline void glmc_mat2f_sub_add(mat2f src_dest, mat2f src_b)
{
    ...
    src_dest[2][1] = src_dest[2][1] + src_b[1][1];
...
inline void glmc_mat2f_mul(mat2f dest, mat2f src_a, mat2f, src_b)
{
    ...
    dest[1][0] = src_a[1][0]*src_b[0][0] + src_a[1][0]*src_b[1][0] + src_a[1][0]*src_b[2][0];
    dest[1][1] = src_a[1][0]*src_b[0][1] + src_a[1][1]*src_b[1][1] + src_a[1][0]*src_b[2][0];
    dest[1][2] = src_a[1][0]*src_b[0][2] + src_a[0][1]*src_b[1][2] + src_a[0][2]*src_b[2][2];
